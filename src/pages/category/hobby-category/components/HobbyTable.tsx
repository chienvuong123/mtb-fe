...
export type THobbyRecord = Partial<HobbyCategoryDTO>;

const HobbyTable: FC<CBaseTable<THobbyRecord>> = ({
  dataSource,
  paginations,
  sortDirection,
  onEdit,
  ...
  const columns: ColumnType<THobbyRecord>[] = useMemo(
    () => [
      {
        title: 'Mã',
        dataIndex: 'code',
  ...
  return (
    <OTable<THobbyRecord>
      ...
      onChange={(_p, _f, s) => {
        const { field, order } = s as SorterResult<THobbyRecord>;
