...
export const ROUTES = {
  ...
  MULTIMEDIA: {
    ...
    AUDIO: buildPath(PATH_SEGMENT.MULTIMEDIA, [PATH_SEGMENT.AUDIO]),
    VIDEO: buildPath(PATH_SEGMENT.MULTIMEDIA, [PATH_SEGMENT.VIDEO]),
    DOCUMENT: buildPath(PATH_SEGMENT.MULTIMEDIA, [PATH_SEGMENT.DOCUMENT]),
    ANIMATED: buildPath(PATH_SEGMENT.MULTIMEDIA, [PATH_SEGMENT.ANIMATED]),
  },
};
